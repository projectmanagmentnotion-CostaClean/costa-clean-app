  ...
  return (
    <section className="data-section">
      <div className="section-header">
        <h2>Gastos</h2>
        <p>Listado operativo de gastos con base fiscal real.</p>
      </div>
      ...
      <SearchBar
        ...
        placeholder="Código, proveedor, descripción, categoría, fecha o importe"
          ...
          {filteredExpenses.map((expense) => {
            ...
            return (
              ...
              >
                ...
                <p>Documento: {getExpenseDocumentTypeLabel(expense.document_type)}</p>
                <p>Pago: {getExpensePaymentStatusLabel(expense.payment_status)}</p>
              </button>
            )
          })}
        </div>
