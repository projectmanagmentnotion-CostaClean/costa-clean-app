...
- **CP-3C.2:** `PARTIAL — CP-3.2R remediated cross-tenant denial and invoice
  download/TTL in QA; two Auth identities, invitation acceptance and integrated
  browser evidence remain`. See
