...
Date: 2026-07-30
Current state: CP-0/CP-1/CP-2A/CP-2A.1/CP-2A.2/CP-2A.3/CP-2A.4/CP-2B/CP-3A/CP-3B.0/CP-3B.0A/CP-3B.0 QA application/CP-3B.1/CP-3B.2A/CP-3B.2A.1/CP-3B.2A.3/CP-3B.2A.4 and CP-3B.2A.5 complete; CP-3B.2A.6 prepared; CP-3B.2A.2 remains blocked by missing V2 detail
...
- Next gate: **CP-3B.2A QA application V6**, requiring a separate exact human
...
CP-3B.2A QA application V6 is the current reproducible rebaseline gate. It is
...
- **CP-3B.2A.6 — Rebaseline reproducible executable package V6:**
  `PREPARED_NOT_AUTHORIZED`; Git blob identity plus canonical JSON identity
  replace the unrecoverable historical mixed-byte pin, while the full V5
  operational contract remains preserved as evidence. No QA or production write
  is authorized.
- **CP-3B.2 — Profile and properties:**
  `BLOCKED_PENDING_CP3B2A_QA_V6`; account context, read models and reviewed
