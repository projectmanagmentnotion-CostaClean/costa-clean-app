...
contains 'bash scripts/cp51f-resolve-pooler-host.sh "$response_file"' "$WORKFLOW"
...
contains 'SUPABASE_CP51F_TEMP_PAT: ${{ secrets.SUPABASE_CP51F_TEMP_PAT }}' "$WORKFLOW"
contains 'scripts/cp51f-resolve-pooler-host.sh "$response_file"' "$WORKFLOW"
