...
export function AppNav({ currentView, onChangeView }: AppNavProps) {
  return (
    <nav className="app-nav">
      ...
      <button
        className={currentView === 'properties' ? 'nav-button active' : 'nav-button'}
      ...
      <button
        className={currentView === 'quotes' ? 'nav-button active' : 'nav-button'}
      ...
      <button
        className={currentView === 'jobs' ? 'nav-button active' : 'nav-button'}
