...
export function InvoiceDetailCard({
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!form.job_id) {
        setSaveError('Debes seleccionar un job.')
        return
      }

      if (!form.client_id) {
        setSaveError('No se pudo resolver el client del job.')
        return
      }
      ...
      <section className="data-section">
        <div className="section-header page-header-actions">
          <div>
            ...
            <p>Vista inicial de detalle de la factura seleccionada.</p>
          </div>
          ...
          <div className="lead-detail-card">
            <div className="lead-detail-header">
              <div>
                ...
                <p>{invoice.invoice_number ?? 'Sin número'}</p>
              </div>
