...
export interface JobProfitability {
  ...
  actual_other_direct_cost: number
  actual_total_direct_cost: number
  actual_direct_contribution_final: number
  direct_margin_final_percent: number | null
  expense_allocation_count: number
