...
export type QuoteOutputIntent = 'print' | 'pdf'
...
function getQuoteRef(quote: QuoteListItem): string {
  return sanitizeFilenamePart(quote.display_code ?? quote.id)
}

export function getQuoteDocumentTitle(
  quote: QuoteListItem,
