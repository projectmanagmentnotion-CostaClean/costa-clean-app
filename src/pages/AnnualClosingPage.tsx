    ...
    <section className="page-section cc-master-page cc-annual-closing-page">
      ...
      {workspace === 'ai_summary' && closing ? (
        <ClosingAiSummarySection
          title="Resumen inteligente anual"
          description="Interpretacion asistiva generada con IA a partir del cierre guardado y de los datos deterministas actuales del ejercicio."
          periodLabel="Ejercicio"
          periodValueLabel={String(selectedYear)}
