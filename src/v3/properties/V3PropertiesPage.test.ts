...
const base = { properties: [property], clients: [{ id: 'client-1', display_code: 'CLI-001', full_name: 'Ana Costa', phone: null, email: null, tax_id: null, billing_address: null, status: 'active', source_lead_id: null }], jobs: [], quotes: [], invoices: [], payments: [], error: null, onRefresh: async () => undefined, onOpenClient: () => undefined, onOpenJob: () => undefined, onOpenQuote: () => undefined, onOpenInvoice: () => undefined, onCreateJob: () => undefined, onCreateQuote: () => undefined, onCreateInvoice: () => undefined }
