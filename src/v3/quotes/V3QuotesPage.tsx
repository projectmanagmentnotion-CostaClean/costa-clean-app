...
function V3QuoteWorkspace({ quote, clients, properties, jobs, invoices, busy, onBack, onDownload, onShare, onRequestConversion, onEdit, onOpenClientWorkspace, onOpenPropertyWorkspace, onOpenJobWorkspace, onOpenInvoiceDetail }: { quote: QuoteListItem; clients: ClientListItem[]; properties: PropertyListItem[]; jobs: JobListItem[]; invoices: InvoiceListItem[]; busy: boolean; onBack: () => void; onDownload: () => void; onShare: () => void; onRequestConversion: (quote: QuoteListItem) => void; onEdit: () => void; onOpenClientWorkspace: (id: string) => void; onOpenPropertyWorkspace: (id: string) => void; onOpenJobWorkspace: (id: string) => void; onOpenInvoiceDetail: (id: string) => void }) {
